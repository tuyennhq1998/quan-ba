                            ...
                            <div class="row border g-0 rounded shadow-sm">
                                <div class="col p-4">
                                    <div class="row justify-content-around"> 
                                            ...
                                            <?php if (session()->get('btnotp') == null): ?>
                                            <button type="submit" id="otp-click" onClick="click_hanld()" class="btn btn-primary" style="width: 100%; background-color:#DE412E">
                                                        Gữi OTP
                                                      </button> <?php endif ?>
                                            </form>
...
<script>
    ...
    ?>
        var url = '<?php echo 'cancel_order/'.session()->get('otp');?>'
