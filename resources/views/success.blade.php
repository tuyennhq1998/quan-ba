            ...
            <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item pr-3">
                        <a class="nav-link" href="#"><i class="fa-solid fa-house-user" style="color: #0067AC;"></i></a>
                    </li>
                    <li class="nav-item pr-3">
                        <a class="nav-link" href="#"><i class="fa-solid fa-right-from-bracket" style="color: #DE412E;"></i></a>
                    </li>
            </div>
